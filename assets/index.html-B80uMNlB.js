import{_ as c,c as i,o as d,e as m}from"./app-DQA98IzN.js";async function p(){const r="https://api.github.com/users/team1157/repos";try{const s=await(await fetch(r)).json(),n=document.getElementById("repo-container");s.forEach(e=>{const o=document.createElement("div");o.className="repo-card",o.innerHTML=`
                    <h2>
